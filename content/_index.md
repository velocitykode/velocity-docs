...
<div class="hx-mt-8 hx-mb-8">
  <h1 class="hero-title" style="font-size: 3.8rem; line-height: 1.1; font-weight: 700; letter-spacing: -0.02em; color: #2c3e50; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif;">
...
<div class="hx-mb-12">
<p class="hero-subtitle" style="font-size: 1.25rem; line-height: 1.6; color: #5a6c7d; font-weight: 400; margin: 0 auto; max-width: 600px;">
...
.hextra-home, main, article {
  overflow-x: hidden !important;
  max-width: 100% !important;
}

.feature-cards-grid, .two-column-section {
  max-width: 100% !important;
  overflow-x: hidden !important;
}

.hero-title, .hero-subtitle, .hx-mt-8, .hx-mb-8, .hx-mb-12, .hx-mb-6 {
  max-width: 100% !important;
...
@media (max-width: 480px) {
  /* Container padding */
  .hextra-home > div, main > div {
    padding-left: 1.25rem !important;
    padding-right: 1.25rem !important;
  }

  /* Smaller logo on mobile */
  nav img, header img, .nav-logo img {
    max-width: 140px !important;
    height: auto !important;
  }

  /* Center hero content on mobile */
  .hx-mt-8, .hx-mb-8, .hx-mb-12, .hx-mb-6 {
  ...
  /* Badge */
  .hextra\/hero-badge, [class*="hero-badge"] {
...
/* Dark mode - change card background and text */
...
<h2 class="hx-mt-16 hx-mb-8 section-title" style="color: #1e3a8a; font-size: 2.5rem; font-weight: 800; letter-spacing: -0.02em;">Why Velocity?</h2>
...
<div class="two-column-section" style="display: flex; gap: 2rem; margin-top: 3rem; width: 100%;">
  <div style="width: 50%;">
    ...
    <ul style="list-style: none; padding-left: 0;">
      <li style="margin-bottom: 1rem; padding-left: 1rem; position: relative;">
        ...
        <strong class="list-item-title">Automatic Route Discovery</strong><br>
        <span class="list-item-desc" style="color: #6b7280;">Routes auto-register from your routes/ directory</span>
      </li>
      <li style="margin-bottom: 1rem; padding-left: 1rem; position: relative;">
        <span style="position: absolute; left: 0; color: #dc2626;">▸</span>
        <strong class="list-item-title">RESTful Resources</strong><br>
        <span class="list-item-desc" style="color: #6b7280;">Built-in support for RESTful controller patterns</span>
      </li>
      <li style="margin-bottom: 1rem; padding-left: 1rem; position: relative;">
        <span style="position: absolute; left: 0; color: #dc2626;">▸</span>
        <strong class="list-item-title">Built-in Logging</strong><br>
        <span class="list-item-desc" style="color: #6b7280;">Production-ready logging with multiple drivers</span>
      </li>
      <li style="margin-bottom: 1rem; padding-left: 1rem; position: relative;">
        <span style="position: absolute; left: 0; color: #dc2626;">▸</span>
        <strong class="list-item-title">Smart Defaults</strong><br>
        <span class="list-item-desc" style="color: #6b7280;">Convention-based routing, auto-initialization, and more</span>
      </li>
    </ul>
  </div>
  ...
  <div style="width: 50%;">
    ...
    <ul style="list-style: none; padding-left: 0;">
      <li style="margin-bottom: 1rem; padding-left: 1rem; position: relative;">
        <span style="position: absolute; left: 0; color: #dc2626;">▸</span>
        <strong class="list-item-title">Type Safety</strong><br>
        <span class="list-item-desc" style="color: #6b7280;">Full Go type checking throughout your application</span>
      </li>
      <li style="margin-bottom: 1rem; padding-left: 1rem; position: relative;">
        <span style="position: absolute; left: 0; color: #dc2626;">▸</span>
        <strong class="list-item-title">Performance</strong><br>
        <span class="list-item-desc" style="color: #6b7280;">Native Go performance with minimal overhead</span>
      </li>
      <li style="margin-bottom: 1rem; padding-left: 1rem; position: relative;">
        <span style="position: absolute; left: 0; color: #dc2626;">▸</span>
        <strong class="list-item-title">Testing</strong><br>
        <span class="list-item-desc" style="color: #6b7280;">Built-in testing utilities and factories</span>
      </li>
      <li style="margin-bottom: 1rem; padding-left: 1rem; position: relative;">
        <span style="position: absolute; left: 0; color: #dc2626;">▸</span>
        <strong class="list-item-title">Production Ready</strong><br>
        <span class="list-item-desc" style="color: #6b7280;">Single binary deployment with embedded assets</span>
      </li>
    </ul>
  </div>
</div>
