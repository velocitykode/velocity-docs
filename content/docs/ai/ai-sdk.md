...
{{% callout type="info" %}}
**Coming soon.** The AI SDK documentation is being written. The module already ships the vector store used on the [Vector search]({{< relref "/docs/database/vector-search" >}}) page; the provider and embeddings surface will be documented here.
{{% /callout %}}
